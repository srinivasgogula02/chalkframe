...
export default function PromptingClient() {
    ...
    return (
        <main className="min-h-screen bg-[#050505] text-zinc-400 overflow-hidden font-mono relative">
            ...
            {/* 0. Top Scarcity Bar */}
            <div className="w-full bg-[#00FF41] text-black text-center py-2 text-sm md:text-base font-bold uppercase tracking-widest relative z-50">
                <span className="animate-pulse mr-2">●</span> LIVE MASTERCLASS REGISTRATION CLOSES IN:
                <span className="ml-2 bg-black px-2 py-0.5 text-[#00FF41]">
            ...
            {/* 1. The Hacker Hero */}
            <motion.section
                className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 pt-10 pb-20 z-10 border-b border-[#00FF41]/20"
            >
                ...
                >
                    ...
                    <motion.div variants={glitchIn} className="pt-10 flex flex-col sm:flex-row items-center gap-6">
                        <Link
                            href="#pricing"
                            className="group relative inline-flex items-center justify-center gap-4 bg-[#00FF41] text-black px-10 py-5 font-bold text-xl uppercase tracking-widest hover:bg-white transition-colors duration-300 w-full sm:w-auto overflow-hidden"
                        >
                            <div className="absolute inset-0 bg-[#00FF41]/50 blur-xl group-hover:opacity-0 transition-opacity"></div>
                            <span className="relative z-10 flex items-center gap-2">Bypass Syntax <ArrowRight weight="bold" className="group-hover:translate-x-2 transition-transform" /></span>
                        </Link>
                        <p className="text-sm text-[#00FF41]/70 uppercase tracking-widest flex items-center gap-2">
                            <LockKeyOpen weight="fill" /> Access unlocks syntax override
                        </p>
                    </motion.div>
                </motion.div>
            </motion.section>
            ...
            <section className="relative z-10 border-b border-[#00FF41]/20">
                <div className="grid lg:grid-cols-2">
                    ...
                    {/* THE OLD DEV */}
                    <div className="p-10 md:p-16 lg:p-24 bg-[#0A0A0A] border-b lg:border-b-0 lg:border-r border-[#00FF41]/20 flex flex-col justify-center">
                        <motion.div
                            initial="hidden"
                            whileInView="show"
                    ...
                    {/* THE AI DEV */}
                    <div className="p-10 md:p-16 lg:p-24 bg-[#030805] flex flex-col justify-center relative overflow-hidden group">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#00FF41]/5 blur-[100px] rounded-full pointer-events-none group-hover:bg-[#00FF41]/10 transition-colors"></div>
            ...
            <section id="pricing" className="py-32 px-6 relative z-10">
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 uppercase tracking-tight">System Access.</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 relative z-10">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="border border-zinc-800 bg-[#0A0A0A] p-10 flex flex-col justify-between"
                        >
                            <div>
                        ...
                        <motion.div
                            ...
                            className="border-2 border-[#00FF41] bg-[#020803] p-10 flex flex-col justify-between relative shadow-[0_0_50px_rgba(0,255,65,0.1)]"
                        >
                            {/* Glowing UI badge */}
                            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#00FF41] text-black text-xs font-bold uppercase tracking-widest py-1 px-4">
                                Root Access // Recommended
                            </div>

                            <div className="relative z-10">
                                <div className="text-[#00FF41]/70 uppercase tracking-widest text-xs mb-6 flex items-center gap-2">
                                    <Database weight="fill" /> Tier 2 // Lifetime Access
                                </div>
                                <h3 className="text-3xl font-bold text-white mb-6 uppercase">The 10x Dev Bundle</h3>

                                <div className="flex items-center gap-1 mb-4">
                                    <CurrencyInr weight="bold" className="text-3xl text-[#00FF41]" />
                                    <span className="text-6xl md:text-7xl font-black text-white leading-none drop-shadow-[0_0_15px_rgba(0,255,65,0.4)]">99</span>
                                </div>
                                <div className="text-[#00FF41]/80 text-xs uppercase tracking-widest mb-10 border-b border-[#00FF41]/20 pb-4">
                                    Less than a cup of coffee.
                                </div>

                                <ul className="space-y-4 text-sm text-zinc-300 uppercase tracking-wide mb-12">
                                    <li className="flex items-start gap-3">
                                        <span className="text-[#00FF41]">+</span> 1-Hour Live Zoom Masterclass
                                    </li>
                                    <li className="flex items-start gap-3">
